...
import SupplierTransactionTable from '../../components/transaction/SupplierTransactionTable'
...
const SupplierTransaction = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Payments', href: '#' },
        { label: 'Supplier Transaction', href: '/admin/marketing/create-coupon' }
      ];
     
        return (
          <div className=" p-4">
             <Breadcrumbs
                  pageTitle="Supplier Transaction"
