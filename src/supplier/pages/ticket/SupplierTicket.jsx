...
import PillTabs from '../../../admin/components/PillTabs'
import SupplierTicketTable from './TicketManagement'
import Breadcrumbs from '../../../admin/components/Breadcrumbs'

const SupplierTicket = () => {
    const tabs_user = [
        { id: 1, label: 'Fresh (1000)' },
        { id: 2, label: 'Replied (800)' },
        { id: 3, label: 'Re-open (100)' },
        { id: 4, label: 'Solved (100)' },
    ...
    const breadcrumbItems = [
        ...
        { label: 'Tickets', href: '#' },
        { label: 'Supplier Tickets', href: '/admin/marketing/create-coupon' }
      ];
     
        return (
          <div className=" p-4">
             <Breadcrumbs
                  pageTitle="Supplier Tickets"
