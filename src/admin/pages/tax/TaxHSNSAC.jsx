            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto bg-gray-100 p-4">
                    <div className="rounded shadow-lg p-2 sm:p-4 bg-white">
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 container w-full items-start md:items-center'>
                            ...
                            <div className="flex items-center gap-2 flex-wrap justify-end md:col-span-2">
