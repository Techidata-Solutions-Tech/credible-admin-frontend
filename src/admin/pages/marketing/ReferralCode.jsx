...
import ReferralCodeTable from '../../components/marketing/ReferralCodeTable'
import PillTabs from '../../components/PillTabs'
import Breadcrumbs from '../../components/Breadcrumbs'

const ReferralCode = () => {
    const topOptions = [
        { id: 2, label: 'Individual (800)' },
        { id: 3, label: 'Business (100)' },
    ];
    const bottomOptions = [
        { id: 2, label: 'Refered (800)' },
        { id: 3, label: 'Used (100)' },
    ];
    ...
    const breadcrumbItems = [
        ...
        { label: 'Referral Code', href: '#' },
        { label: 'Manage Referral Code', href: '/admin/marketing/create-coupon' }
      ];
        ...
        return (
          <div className=" p-2 bg-white">
             <Breadcrumbs
                ...
                /> 
                  <div className="bg-gradient-to-r from-blue-500 to-teal-400 p-1 rounded-md shadow-sm overflow-x-auto flex flex-col items-center justify-center">
