...
import InventoryManagementDeadStockTable from '../../components/inventory/InventoryManagementDeadStockTable'
import PillTabs from '../../components/PillTabs'
import Breadcrumbs from '../../components/Breadcrumbs'

const InventoryManagementDeadStock = () => {
    const tabs_user = [
        { id: 1, label: 'All (1000)' },
    ...
    const breadcrumbItems = [
        ...
        { label: 'Manage Product Inventory', href: '/admin/marketing/create-coupon' }
      ];
     
        return (
          <div className=" bg-white p-2">
             <Breadcrumbs
                  pageTitle="Manage Product Inventory"
  ...
  <div className="dropdown">
    ...
    >
      ...
      <li><label><input type="checkbox" /> Checkbox Label</label></li>
                    ...
                    <InventoryManagementDeadStockTable />
...
export default InventoryManagementDeadStock