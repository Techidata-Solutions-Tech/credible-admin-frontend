...
import InventoryManagementSellerTable from '../../components/inventory/InventoryManagementSellerTable'
import PillTabs from '../../components/PillTabs'
import Breadcrumbs from '../../components/Breadcrumbs'

const InventoryManagementSeller = () => {
    const tabs_user = [
        { id: 1, label: 'All (1000)' },
    ...
    const breadcrumbItems = [
        ...
        { label: 'Sellerwise Inventory', href: '/admin/marketing/create-coupon' }
      ];
     
        return (
          <div className=" bg-white p-2">
             <Breadcrumbs
                  pageTitle="Sellerwise Inventory"
  ...
  <div className="dropdown">
    ...
    >
      ...
      <li><label><input type="checkbox" /> Checkbox Label</label></li>
                    ...
                    <InventoryManagementSellerTable />
...
export default InventoryManagementSeller