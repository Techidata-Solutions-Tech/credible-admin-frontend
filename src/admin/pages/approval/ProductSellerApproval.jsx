...
import ProductSellerApprovalTable from '../../components/approval/ProductSellerApprovalTable'
...
const ProductSellerApproval = () => {
    ...
    const breadcrumbItems = [
        ...
        { label: 'Product', href: '#' },
        { label: 'Seller Product', href: '/admin/approval/product/supplier' }
      ];
...
export default ProductSellerApproval