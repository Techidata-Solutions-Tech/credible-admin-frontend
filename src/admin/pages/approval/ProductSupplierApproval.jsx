...
import ProductSupplierApprovalTable from '../../components/approval/ProductSupplierApprovalTable'
import Breadcrumbs from '../../components/Breadcrumbs'

const ProductSupplierApproval = () => {
    const tabs_user = [
        { id: 1, label: 'All (1000)' },
    ...
    const breadcrumbItems = [
        ...
        { label: 'Product', href: '#' },
        { label: 'Supplier Product', href: '/admin/approval/product/supplier' }
      ];
  
    return (
        <div className='min-h-screen'>
                <Breadcrumbs
                  pageTitle="Supplier Product"
...
export default ProductSupplierApproval