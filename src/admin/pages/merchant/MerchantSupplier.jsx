...
import MerchantSupplierTable from '../../components/merchant/MerchantSupplierTable'
import PillTabs from '../../components/PillTabs'
import Breadcrumbs from '../../components/Breadcrumbs'

const MerchantSupplier = () => {
    const tabs_user = [
        { id: 1, label: 'All (1000)' },
    ...
    const breadcrumbItems = [
        ...
        { label: 'Manage Supplier', href: '/admin/approval/product/supplier' }
      ];
...
export default MerchantSupplier