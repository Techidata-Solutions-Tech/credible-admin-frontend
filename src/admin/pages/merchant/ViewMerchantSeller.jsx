...
const ViewMerchantSeller = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: 'View Seller', href: '/admin/approval/product/supplier' }
  ];
  ...
  <div className="dropdown">
    ...
    >
     ...
     <table className="min-w-full border border-gray-400">
        <thead>
          <tr className="bg-green-600 text-white text-center text-sm uppercase">
...
export default ViewMerchantSeller;
