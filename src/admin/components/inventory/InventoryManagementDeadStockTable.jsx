...
const InventoryManagementDeadStockTable = () => {
  ...
  const deadStockData = [
    ...
    // Add more data here for testing pagination with more records
  ];

  // Pagination logic
  const indexOfLastRecord = currentPage * recordsPerPage;
  const indexOfFirstRecord = indexOfLastRecord - recordsPerPage;
  const currentRecords = deadStockData.slice(indexOfFirstRecord, indexOfLastRecord);
  ...
  return (
    <>
      ...
      <Pagination
        totalRecords={deadStockData.length}
